...
本目录包含 Strategic Analyst 的方法论文档、最佳实践指南和学习资源。

## 📖 文档分类

### 方法论文档
- [结构化思维入门指南](./methodology/structured-thinking-guide.md) - 战略分析的思维基础 🆕
- [MECE 原则应用手册](./methodology/mece-principle.md) - 相互独立，完全穷尽
- [金字塔原则](./methodology/pyramid-principle.md) - 结论先行，自上而下
